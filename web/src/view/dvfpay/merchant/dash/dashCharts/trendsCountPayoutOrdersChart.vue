...
<script>
export default {
  name: 'TrendsCountPayoutOrdersChart',
}
</script>
...
import { getMerchantTrendsCountPayoutOrder } from '@/api/dvfpay/payoutOrder'
...
const getData = async() => {
  ...
  const table = await getMerchantTrendsCountPayoutOrder()
  if (table.code === 0) {
